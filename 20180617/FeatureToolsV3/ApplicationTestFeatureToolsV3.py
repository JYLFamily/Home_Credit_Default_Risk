...
class ApplicationTestFeatureToolsV4(object):
    ...
    def es_set(self):
        ...
        self.__es["previous_application"]["NAME_CONTRACT_STATUS"].interesting_values = ["Refused"]
        self.__es["previous_application"]["NAME_PRODUCT_TYPE"].interesting_values = ["walk-in"]

    def dfs_run(self):
        self.__feature, _ = ft.dfs(
            entityset=self.__es,
            target_entity="application_test",
            agg_primitives=[Sum, Std, Max, Min, Median, Count, Mode, NUnique],
            trans_primitives=[],
            verbose=True,
...
if __name__ == "__main__":
    atftv4 = ApplicationTestFeatureToolsV4(
