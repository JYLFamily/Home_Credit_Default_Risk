...
class LightGbmKfold(object):
    def __init__(self, *, input_path, output_path):
        ...
        self.__gp_train, self.__gp_test = [None for _ in range(2)]
    ...
    def data_prepare(self):
        ...
        self.__gp_train = pd.read_csv(os.path.join(self.__input_path, "genetic_train_feature.csv"))
        self.__gp_test = pd.read_csv(os.path.join(self.__input_path, "genetic_test_feature.csv"))
        ...
        self.__train_feature = pd.concat([self.__train_feature, self.__gp_train], axis=1)
        self.__test_feature = pd.concat([self.__test_feature, self.__gp_test], axis=1)
