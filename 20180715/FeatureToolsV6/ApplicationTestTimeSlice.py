...
class ApplicationTestTimeSlice(object):
    ...
    def data_prepare(self):
        self.__application_test = pd.read_csv(
            os.path.join(self.__input_path, "application_test.csv"),
            usecols=["SK_ID_CURR"]
        )
    ...
    def data_output(self):
        self.__application_test.to_csv(
            os.path.join(self.__output_path, "application_test_time_slice.csv"),
            index=False
        )


if __name__ == "__main__":
    atts = ApplicationTestTimeSlice(
